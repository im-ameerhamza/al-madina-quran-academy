          ...
          <div class="discount-wrapp">
            ...
            <div class="discount-tag">
              <svg class="discount-anime" viewBox="0 0 190 190" role="img" aria-label="Learn Quran everyday">
                <defs>
                  <path id="discount-text-path" d="M 95,95 m -76,0 a 76,76 0 1,1 152,0 a 76,76 0 1,1 -152,0" />
                </defs>
                <text textLength="478" lengthAdjust="spacing">
                  <textPath href="#discount-text-path" startOffset="0">LEARN QURAN EVERYDAY * QURAN LEARN *</textPath>
                </text>
              </svg>
            </div>
          </div>
      ...
      <div class="col-xxl-6 mb-30 mb-xl-0">
        ...
        <?php if ($showReadMore): ?>
          <div
            ...
            data-wow-delay=".8s">
            <a href="/about-us" class="th-btn" aria-label="Read More">
              <span
                class="btn-text"
                data-back="Read More"
                data-front="Read More"></span>
            </a>
          </div>
        <?php endif; ?>
        ...
        <div
          ...
          <div
            ...
            <a
              ...
              aria-label="Watch the introductory video">
